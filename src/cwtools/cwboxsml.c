/*
 * DESCRIPTION:
 * Chadwick boxscore generator program: SportsML module
 * 
...
{
  XMLNode *node = NULL;
  int pos, outs = 0, po = 0, a = 0, e = 0, dp = 0, tp = 0, pb = 0;
			    ...
			    CWGame *game, CWBoxPitcher *pitcher)
{
  ...
  xml_node_attribute(node, "shutouts",
			  ...
			  CWGame *game, CWBoxscore *boxscore, int t)
{
  ...
  int ab = 0, r = 0, h = 0, b2 = 0, b3 = 0, hr = 0, bi = 0;
  int bb = 0, ibb = 0, so = 0, gdp = 0, hp = 0, sh = 0, sf = 0;
  int sb = 0, cs = 0;

  int e = 0, pb = 0;

  int outs = 0, ha = 0, ra = 0, er = 0, hra = 0, bba = 0, soa = 0;
  int sha = 0, sfa = 0, hb = 0, wp = 0, bk = 0;
